        ...
        <div class="container">
            <div class="row pt-5">
                <div class="col-lg-2"></div>
                    <div class="col-lg-8 animated slideInDown">
            ...
            <div class="row">
                <div class="col-lg-4 pr-5 animated slideInLeft">
                ...
                <div class="col-lg-4 pr-5 animated slideInUp">
                    <div class="card mb-4 shadow-sm border">
                ...
                <div class="col-lg-4 pr-5 animated slideInRight">
                    <div class="card mb-4 shadow-sm border ">
                        <div class="card-header aqua-gradient text-white">
