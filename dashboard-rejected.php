    ...
    <div class="row mb-4">
            <div class="sidebar col-xs-12 col-sm-4 col-lg-4 col-xl-3 center-align" style="height:800px;">
                    ...
                    <div class="col-md-3 col-sm-6" style="margin-top:425px; position: fixed">
                            <nav>                                    
                                <ul class="nav nav-pills flex-column sidebar-nav">
                                    ...
                                    <li class="nav-item"><a href="dashboard-rejected.php" class="nav-link active font-weight-bold"><em class="fa fa-times-circle"></em> Reject </a></li>
                                </ul>
                            </nav>
                        </div>
                </div>
                <?php
                    ...
                    WHERE certificates.agency_id = agencies.id AND certificates.status = 'r' AND certificates.user_id = $id";
